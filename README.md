...
> 基于 [Superpowers](https://github.com/obra/superpowers) 的 VS Code Copilot 中文适配版，融合 gem-agents 多代理编排系统。

Superpowers for Copilot 将 Superpowers 的技能体系与 gem-agents 的多代理编排能力结合，为 VS Code GitHub Copilot 提供完整的 AI 驱动软件开发工作流。
...
```bash
git clone https://github.com/anthropic-works/superpowers4copilot.git ~/.copilot/superpowers4copilot
```
...
本项目基于 [obra/superpowers](https://github.com/obra/superpowers)，定期同步上游更新并适配 VS Code Copilot 生态。

主要增强：
- **gem-agents 多代理编排系统**（12 个专业代理）
